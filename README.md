...
> [!WARNING]
> **This is the WebRTC Feature Branch**. It aims to add WebRTC support for StealthPipe so it can try establishing a direct P2P connection for lower ping when possible. Otherwise, it will fallback to the old WSS relay-based system.
